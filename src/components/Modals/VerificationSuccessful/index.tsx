...
export interface VerificationSuccessfulModalProps {
    opened: boolean
    //setOpened: React.Dispatch<React.SetStateAction<boolean>>
}

const VerificationSuccessfulModal = ({
    opened,
    //setOpened,
}: VerificationSuccessfulModalProps) => {
        ...
        >
            <div className="flex flex-col items-center justify-center p-4 ">
                    ...
                    <p className="font-medium text-base text-center mb-8">
                        Your have been verified successfully. Click the button
                        below to continue using the app.
                    </p>
