    ...
    return (
        <Layout pageTitle="Help&Support">
            <div className=" pt-28 h-screen text-black-100 bg-[#FBFBFB]">
                ...
                <div className="mt-7">
                    <p
                        className="text-[24px] md:text-[35px] lg:text-[24px] font-medium text-[#101214]
                    text-center"
                    >
                        How can we help?
                    </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-14 ml-10 lg:ml-28 justify-center">
                    <div className="flex items-start">
                        ...
                        <div className="bg-white">
                            <h2 className="text-[16px] leading-5 font-semibold mb-2">
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="bg-white">
                            ...
                            <Link
                                to="https://husridge.com/pricing"
                                className="text-[#475569] font-semibold"
                            >
                                See Pricing List &rarr;
                            </Link>
                        </div>
                    </div>
