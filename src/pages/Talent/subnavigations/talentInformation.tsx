...
import { useGetInquiries, useGetInquiriesByTalentId } from "@hooks/useInquiry"
        ...
        <Layout>
            ...
            isLoadingEventsById ? (
                ...
                <div className="p-4 pt-28 ">
                    ...
                    {data?.data.verificationTypeValue === String("pending") ? (
                        <EmptyState
                            text={`${data?.data.fullName} needs to approve management request for you to manage their profile`}
                        />
                    ) : (
                        <>
                            {" "}
